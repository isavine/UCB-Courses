 ...
 closeCal2(obj);if(!bTabonly || getLastKey_win0() == "\t".charCodeAt(0))
{
 ...
 {
 oChange_win0.form.ICFocus.value=obj.id; submitAction_win0(oChange_win0.form,oChange_win0.id); oChange_win0 = null; }
...
if (typeof obj == "undefined" && typeof id == "undefined") return;if (obj) id = obj.id; else obj = document.getElementById(id);if (!obj || id.length == 0) return;if (isFModeLayout() && obj.type == "select-one")
...
if (obj.type == "checkbox" || obj.type == "radio")
 ...
 {
 if(!obj.disabled)
 return !(obj.options[obj.selectedIndex].defaultSelected); return false; }
 }
